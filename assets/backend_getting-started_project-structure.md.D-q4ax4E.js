import{_ as s,c as n,o as p,aG as i}from"./chunks/framework.CrOSaJJH.js";const k=JSON.parse('{"title":"프로젝트 구조","description":"","frontmatter":{},"headers":[],"relativePath":"backend/getting-started/project-structure.md","filePath":"backend/getting-started/project-structure.md"}'),e={name:"backend/getting-started/project-structure.md"};function l(t,a,o,c,r,h){return p(),n("div",null,a[0]||(a[0]=[i(`<h1 id="프로젝트-구조" tabindex="-1">프로젝트 구조 <a class="header-anchor" href="#프로젝트-구조" aria-label="Permalink to &quot;프로젝트 구조&quot;">​</a></h1><p>이 문서는 AxpFramework 프로젝트의 전체 구조와 각 디렉토리의 역할을 설명합니다.</p><h2 id="전체-디렉토리-구조" tabindex="-1">전체 디렉토리 구조 <a class="header-anchor" href="#전체-디렉토리-구조" aria-label="Permalink to &quot;전체 디렉토리 구조&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>AxpFramework/</span></span>
